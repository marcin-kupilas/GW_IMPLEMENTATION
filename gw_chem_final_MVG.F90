...
!------------------------------Arguments--------------------------------
 ...
 ! k_tilde, psi_bar, k_h_m, k_wave_new, k_h_new MMK
...
!==================================================================
  ...
  enddo
   ...
   ! MMK TEMPERATURE
   ! Decompose the diffusion matrix using k_h_new MMK
   ! decomp = fin_vol_lu_decomp(dt, p%section([1,ncol],[ktop,kbot_tend]), & ! MMK
   ! coef_q_diff=k_h_new(:,ktop:kbot_tend+1)*dpidz_sq(:,ktop:kbot_tend+1)) ! MMK
